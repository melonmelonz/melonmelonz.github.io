...
Made for the Next Chapter application. Tools used: mix of nvim, avante, claude/mistral models, ccode and sometimes VSCodium for specific plugins. Oh and I typically use Prettier on-save.
