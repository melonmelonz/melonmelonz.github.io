...
Made for the Next Step application. Tools used: mix of nvim, avante, claude/mistral modles, ccode and sometimes VSCodium for specific plugins. Oh and I typically use Prettier on-save.
